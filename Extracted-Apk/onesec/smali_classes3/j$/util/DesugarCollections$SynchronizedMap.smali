.class final Lj$/util/DesugarCollections$SynchronizedMap;
...
.method private static instantiateSet(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/Set;
    .locals 3
...
.method public final entrySet()Ljava/util/Set;
    ...
    invoke-static {v1, v2}, Lj$/util/DesugarCollections$SynchronizedMap;->instantiateSet(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/Set;
...
.method public final forEach(Lj$/util/function/BiConsumer;)V
    ...
    invoke-static {v1, p1}, Lj$/util/function/Function$-CC;->$default$forEach(Ljava/util/concurrent/ConcurrentMap;Lj$/util/function/BiConsumer;)V
...
.method public final replaceAll(Lj$/util/function/BiFunction;)V
    ...
    .line 0
    new-instance v2, Lj$/util/function/Consumer$$ExternalSyntheticLambda0;

    const/4 v3, 0x1

    invoke-direct {v2, v3, v1, p1}, Lj$/util/function/Consumer$$ExternalSyntheticLambda0;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    .line 0
    instance-of p1, v1, Lj$/util/concurrent/ConcurrentMap;

    if-eqz p1, :cond_1

    check-cast v1, Lj$/util/concurrent/ConcurrentMap;

    invoke-interface {v1, v2}, Lj$/util/concurrent/ConcurrentMap;->forEach(Lj$/util/function/BiConsumer;)V

    goto :goto_0

    :cond_1
    invoke-static {v1, v2}, Lj$/util/function/Function$-CC;->$default$forEach(Ljava/util/concurrent/ConcurrentMap;Lj$/util/function/BiConsumer;)V
