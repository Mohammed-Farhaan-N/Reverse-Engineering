...
.method private sourceSpliterator(I)Lj$/util/Spliterator;
    ...
    :cond_1
    invoke-virtual {v2, v0, v1}, Lj$/util/stream/AbstractPipeline;->opEvaluateParallelLazy(Lj$/util/stream/AbstractPipeline;Lj$/util/Spliterator;)Lj$/util/Spliterator;
...
.method final copyInto(Lj$/util/Spliterator;Lj$/util/stream/Sink;)V
    .locals 2
    ...
    invoke-interface {p2, v0, v1}, Lj$/util/stream/Sink;->begin(J)V

    invoke-interface {p1, p2}, Lj$/util/Spliterator;->forEachRemaining(Lj$/util/function/Consumer;)V

    invoke-interface {p2}, Lj$/util/stream/Sink;->end()V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/AbstractPipeline;->copyIntoWithCancel(Lj$/util/Spliterator;Lj$/util/stream/Sink;)V

    :goto_0
    return-void
.end method

.method final copyIntoWithCancel(Lj$/util/Spliterator;Lj$/util/stream/Sink;)V
    .locals 3
    ...
    invoke-interface {p2, v1, v2}, Lj$/util/stream/Sink;->begin(J)V

    invoke-virtual {v0, p1, p2}, Lj$/util/stream/AbstractPipeline;->forEachWithCancel(Lj$/util/Spliterator;Lj$/util/stream/Sink;)V
...
.method final evaluate(Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/Node;
    ...
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/AbstractPipeline;->wrapAndCopyInto(Lj$/util/Spliterator;Lj$/util/stream/Sink;)Lj$/util/stream/Sink;
...
.method final evaluateToArrayNode(Lj$/util/function/IntFunction;)Lj$/util/stream/Node;
    ...
    invoke-virtual {p0, v1, p1, v0}, Lj$/util/stream/AbstractPipeline;->opEvaluateParallel(Lj$/util/Spliterator;Lj$/util/function/IntFunction;Lj$/util/stream/AbstractPipeline;)Lj$/util/stream/Node;
...
.method opEvaluateParallel(Lj$/util/Spliterator;Lj$/util/function/IntFunction;Lj$/util/stream/AbstractPipeline;)Lj$/util/stream/Node;
    .locals 0
...
.method opEvaluateParallelLazy(Lj$/util/stream/AbstractPipeline;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    .locals 2
    ...
    invoke-virtual {p0, p2, v0, p1}, Lj$/util/stream/AbstractPipeline;->opEvaluateParallel(Lj$/util/Spliterator;Lj$/util/function/IntFunction;Lj$/util/stream/AbstractPipeline;)Lj$/util/stream/Node;
...
.method public spliterator()Lj$/util/Spliterator;
    ...
    invoke-direct {v1, v2, p0}, Lj$/util/stream/SpinedBuffer$$ExternalSyntheticLambda0;-><init>(ILjava/lang/Object;)V

    .line 0
    iget-boolean v0, v0, Lj$/util/stream/AbstractPipeline;->parallel:Z

    .line 0
    invoke-virtual {p0, p0, v1, v0}, Lj$/util/stream/AbstractPipeline;->wrap(Lj$/util/stream/Node$-CC;Lj$/util/stream/SpinedBuffer$$ExternalSyntheticLambda0;Z)Lj$/util/Spliterator;
...
.method abstract wrap(Lj$/util/stream/Node$-CC;Lj$/util/stream/SpinedBuffer$$ExternalSyntheticLambda0;Z)Lj$/util/Spliterator;
.end method

.method final wrapAndCopyInto(Lj$/util/Spliterator;Lj$/util/stream/Sink;)Lj$/util/stream/Sink;
    .locals 1
    ...
    invoke-virtual {p0, p1, v0}, Lj$/util/stream/AbstractPipeline;->copyInto(Lj$/util/Spliterator;Lj$/util/stream/Sink;)V
...
.method final wrapSpliterator(Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-direct {v0, v1, p1}, Lj$/util/stream/SpinedBuffer$$ExternalSyntheticLambda0;-><init>(ILjava/lang/Object;)V
    ...
    .line 0
    invoke-virtual {p0, p0, v0, p1}, Lj$/util/stream/AbstractPipeline;->wrap(Lj$/util/stream/Node$-CC;Lj$/util/stream/SpinedBuffer$$ExternalSyntheticLambda0;Z)Lj$/util/Spliterator;
