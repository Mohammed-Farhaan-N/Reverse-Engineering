...
.method constructor <init>(Lj$/util/stream/AbstractPipeline;IJJ)V
    ...
    iput-wide p3, p0, Lj$/util/stream/SliceOps$3;->val$skip:J

    iput-wide p5, p0, Lj$/util/stream/SliceOps$3;->val$limit:J

    invoke-direct {p0, p1, p2}, Lj$/util/stream/LongPipeline$StatefulOp;-><init>(Lj$/util/stream/AbstractPipeline;I)V

    return-void
.end method

.method static unorderedSkipLimitSpliterator(Lj$/util/Spliterator$OfLong;JJJ)Lj$/util/Spliterator$OfLong;
    .locals 8
    ...
    :goto_1
    new-instance p1, Lj$/util/stream/StreamSpliterators$UnorderedSliceSpliterator$OfLong;
...
.method final opEvaluateParallel(Lj$/util/Spliterator;Lj$/util/function/IntFunction;Lj$/util/stream/AbstractPipeline;)Lj$/util/stream/Node;
    ...
    iget-wide v4, v9, Lj$/util/stream/SliceOps$3;->val$skip:J
    ...
    invoke-static {v6, v0, v10}, Lj$/util/stream/Node$-CC;->collectLong(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;Z)Lj$/util/stream/Node$OfLong;
    ...
    iget-wide v1, v9, Lj$/util/stream/SliceOps$3;->val$skip:J

    iget-wide v3, v9, Lj$/util/stream/SliceOps$3;->val$limit:J

    move-wide v5, v7

    invoke-static/range {v0 .. v6}, Lj$/util/stream/SliceOps$3;->unorderedSkipLimitSpliterator(Lj$/util/Spliterator$OfLong;JJJ)Lj$/util/Spliterator$OfLong;

    move-result-object v0

    invoke-static {p0, v0, v10}, Lj$/util/stream/Node$-CC;->collectLong(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;Z)Lj$/util/stream/Node$OfLong;
    ...
    iget-wide v7, v9, Lj$/util/stream/SliceOps$3;->val$skip:J

    iget-wide v11, v9, Lj$/util/stream/SliceOps$3;->val$limit:J
...
.method final opEvaluateParallelLazy(Lj$/util/stream/AbstractPipeline;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    check-cast v8, Lj$/util/Spliterator$OfLong;

    iget-wide v9, p0, Lj$/util/stream/SliceOps$3;->val$skip:J

    iget-wide p1, p0, Lj$/util/stream/SliceOps$3;->val$limit:J
    ...
    invoke-direct/range {v7 .. v12}, Lj$/util/stream/StreamSpliterators$SliceSpliterator$OfLong;-><init>(Lj$/util/Spliterator$OfLong;JJ)V
