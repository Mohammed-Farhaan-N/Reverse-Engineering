...
.method public final doubles()Ljava/util/stream/DoubleStream;
    ...
    invoke-static {v9}, Lj$/util/stream/StreamSupport;->doubleStream(Lj$/util/Spliterator$OfDouble;)Lj$/util/stream/DoubleStream;
...
.method public final doubles(DD)Ljava/util/stream/DoubleStream;
    ...
    invoke-static {v0}, Lj$/util/stream/StreamSupport;->doubleStream(Lj$/util/Spliterator$OfDouble;)Lj$/util/stream/DoubleStream;
...
.method public final ints()Ljava/util/stream/IntStream;
    ...
    invoke-static {v7}, Lj$/util/stream/StreamSupport;->intStream(Lj$/util/Spliterator$OfInt;)Lj$/util/stream/IntStream;
...
.method public final ints(J)Ljava/util/stream/IntStream;
    ...
    invoke-static {v0}, Lj$/util/stream/StreamSupport;->intStream(Lj$/util/Spliterator$OfInt;)Lj$/util/stream/IntStream;
...
.method public final longs()Ljava/util/stream/LongStream;
    ...
    invoke-static {v9}, Lj$/util/stream/StreamSupport;->longStream(Lj$/util/Spliterator$OfLong;)Lj$/util/stream/LongStream;
...
.method public final longs(J)Ljava/util/stream/LongStream;
    ...
    invoke-static {v0}, Lj$/util/stream/StreamSupport;->longStream(Lj$/util/Spliterator$OfLong;)Lj$/util/stream/LongStream;
