...
.field private static final QUERY_REGION_ONLY:Lj$/time/format/DateTimeFormatter$$ExternalSyntheticLambda0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj$/time/format/DateTimeFormatterBuilder;->QUERY_REGION_ONLY:Lj$/time/format/DateTimeFormatter$$ExternalSyntheticLambda0;
...
.method private appendValue(Lj$/time/format/DateTimeFormatterBuilder$NumberPrinterParser;)V
    .locals 4
...
# virtual methods
.method public final append(Lj$/time/format/DateTimeFormatter;)V
    .locals 0
...
.method public final appendFraction(Lj$/time/temporal/ChronoField;)V
    .locals 1

    new-instance v0, Lj$/time/format/DateTimeFormatterBuilder$FractionPrinterParser;

    invoke-direct {v0, p1}, Lj$/time/format/DateTimeFormatterBuilder$FractionPrinterParser;-><init>(Lj$/time/temporal/ChronoField;)V
...
.method public final appendInstant()V
    .locals 1
...
.method public final appendLiteral(C)V
    .locals 1
...
.method public final appendLiteral(Ljava/lang/String;)V
    .locals 2
...
.method public final appendOffset(Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
...
.method public final appendOffsetId()V
    .locals 1
...
.method public final appendText(Lj$/time/temporal/ChronoField;Ljava/util/HashMap;)V
    .locals 2
    ...
    invoke-direct {v1, p1, p2, v0}, Lj$/time/format/DateTimeFormatterBuilder$TextPrinterParser;-><init>(Lj$/time/temporal/ChronoField;Lj$/time/format/TextStyle;Lj$/time/format/DateTimeFormatterBuilder$1;)V
...
.method public final appendValue(Lj$/time/temporal/TemporalField;I)V
    .locals 2
    ...
    invoke-direct {p0, v0}, Lj$/time/format/DateTimeFormatterBuilder;->appendValue(Lj$/time/format/DateTimeFormatterBuilder$NumberPrinterParser;)V
...
.method public final appendValue$enumunboxing$(Lj$/time/temporal/TemporalField;III)Lj$/time/format/DateTimeFormatterBuilder;
    ...
    invoke-virtual {p0, p1, p3}, Lj$/time/format/DateTimeFormatterBuilder;->appendValue(Lj$/time/temporal/TemporalField;I)V
...
.method public final appendZoneRegionId()V
    .locals 2

    new-instance v0, Lj$/time/format/DateTimeFormatterBuilder$ZoneIdPrinterParser;

    sget-object v1, Lj$/time/format/DateTimeFormatterBuilder;->QUERY_REGION_ONLY:Lj$/time/format/DateTimeFormatter$$ExternalSyntheticLambda0;

    invoke-direct {v0, v1}, Lj$/time/format/DateTimeFormatterBuilder$ZoneIdPrinterParser;-><init>(Lj$/time/format/DateTimeFormatter$$ExternalSyntheticLambda0;)V
...
.method public final optionalEnd()V
    .locals 3
    ...
    invoke-direct {v0, v2, v1}, Lj$/time/format/DateTimeFormatterBuilder$CompositePrinterParser;-><init>(Ljava/util/ArrayList;Z)V
...
.method public final optionalStart()V
    .locals 2
...
.method public final parseCaseInsensitive()V
    .locals 1
...
.method public final parseCaseSensitive()V
    .locals 1
...
.method public final parseLenient()V
    .locals 1
...
.method final toFormatter$enumunboxing$(ILj$/time/chrono/IsoChronology;)Lj$/time/format/DateTimeFormatter;
    .locals 4
    ...
    invoke-virtual {p0}, Lj$/time/format/DateTimeFormatterBuilder;->optionalEnd()V
    ...
    invoke-direct {v1, v2, v3}, Lj$/time/format/DateTimeFormatterBuilder$CompositePrinterParser;-><init>(Ljava/util/ArrayList;Z)V
    ...
    invoke-direct {v2, v1, v0, p1, p2}, Lj$/time/format/DateTimeFormatter;-><init>(Lj$/time/format/DateTimeFormatterBuilder$CompositePrinterParser;Ljava/util/Locale;ILj$/time/chrono/IsoChronology;)V
